        ...
        <>
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              onClick={() => checkInProduct(image)}
              className="w-full h-10 font-100 disabled:border-gray-400 disabled:text-gray-400 disabled:hover:bg-transparent border-primary border-2 text-primary hover:bg-primary hover:text-white rounded"
            >
  ...
  return (
    <>
      <Hero
        img={"delivery.png"}
        des={
          "You have successfully logged in through a delivery service account!"
        }
